 ...
 * runtime detection.
 */
int arm_cpu_enable_crc32 = 1;
int arm_cpu_enable_pmull = 1;
#else
...
int x86_cpu_enable_avx512 = 0;

int riscv_cpu_enable_rvv = 0;
int riscv_cpu_enable_vclmul = 0;
...
static void _cpu_check_features(void)
{
    ...
    x86_cpu_enable_simd = x86_cpu_has_ssse3 &&
